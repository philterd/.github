...
_Describe whether the feature has any security considerations or impact. What is the security model of the new APIs?_
...
_Describe the value that this feature will bring to the Philterd community, as well as what impact it has if it isn't built, or new risks if it is. Highlight opportunities for additional research._
